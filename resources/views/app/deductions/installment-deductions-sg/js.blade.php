        ...
        $(document).ready(function(){
            ...
            var viewModel = kendo.observable({ 
                ...
                ds : {
                    ...
                    typesgrid : new kendo.data.DataSource({
                        transport : {   
                            read : {
                                url : 'installments-sg/list-types',
                                type : 'get',
                                dataType : 'json',
                                complete : function(e){
                    ...
                    payperiod : new kendo.data.DataSource({
                        transport : {   
                            read : {
                                url : 'installments-sg/list-payroll-period',
                                type : 'get',
                                dataType : 'json',
                                complete : function(e){
                    ...
                    employeegrid : new kendo.data.DataSource({ 
                        transport : {
                            read : {
                                url : 'installments-sg/employee-list',
                                type : 'get',
                                dataType : 'json',
                                complete : function(e){
                    ...
                    schedlist : new kendo.data.DataSource({ 
                        transport : {
                            read : {
                                url : 'installments-sg/deduct-sched-list',
                                type : 'get',
                                dataType : 'json',
                                complete : function(e){
                ...
                buttonHandler : {
                    save : async function(e){
                        ...
                        $.post('installments-sg/save',{
                            data : json_data
                        },function(data,staus){
                            swal_success(data);

                            let url  = `installments-sg/read-header/${data}`;
                            read(url,viewModel);
                    ...
                    showAll : function()
                    {
                        viewModel.ds.maingrid.transport.options.read.url = `installments-sg/list/0`;
                        viewModel.ds.maingrid.read();
                    },

                    downloadNonConfi : function() {
                        let url = 'installments-sg/download-non-confi';
                        window.open(url);
                    },
            ...
            $("#employeegrid").kendoGrid({
                ...
                columns : [
                    ...
                    viewModel.ds.maingrid.transport.options.read.url = `installments-sg/list/${selectedItem.biometric_id}`;
                    viewModel.ds.maingrid.read();
                }
            });

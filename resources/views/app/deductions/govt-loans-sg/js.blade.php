        ...
        var viewModel = kendo.observable({ 
                ...
                ds : {
                    maingrid : new kendo.data.DataSource({
                        transport : {
                            read : {
                                url : 'government-loans-sg/list/0',
                                type : 'get',
                                dataType : 'json',
                                complete : function(e){
                    ...
                    typesgrid : new kendo.data.DataSource({
                        transport : {   
                            read : {
                                url : 'government-loans-sg/list-types',
                                type : 'get',
                                dataType : 'json',
                                complete : function(e){
                    ...
                    payperiod : new kendo.data.DataSource({
                        transport : {   
                            read : {
                                url : 'government-loans-sg/list-payroll-period',
                                type : 'get',
                                dataType : 'json',
                                complete : function(e){
                    ...
                    employeegrid : new kendo.data.DataSource({ 
                        transport : {
                            read : {
                                url : 'government-loans-sg/employee-list',
                                type : 'get',
                                dataType : 'json',
                                complete : function(e){
                    ...
                    schedlist : new kendo.data.DataSource({ 
                        transport : {
                            read : {
                                url : 'government-loans-sg/deduct-sched-list',
                                type : 'get',
                                dataType : 'json',
                                complete : function(e){
                ...
                buttonHandler : {
                    save : async function(e){
                        ...
                        $.post('government-loans-sg/save',{
                            data : json_data
                        },function(data,staus){
                            swal_success(data);

                            let url  = `government-loans-sg/read-header/${data}`;
                            read(url,viewModel);
            ...
            $("#employeegrid").kendoGrid({
                ...
                columns : [
                    ...
                    viewModel.ds.maingrid.transport.options.read.url = `government-loans-sg/list/${selectedItem.biometric_id}`;
                    viewModel.ds.maingrid.read();
                }
            });

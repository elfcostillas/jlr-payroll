                    ...
                    <div class="card-body">
                        <table class="formTable" border=0 style="width:100%">
                            ...
                            <tr>
                                ...
                                <td colspan=2>Alternate Saturday</td>
                                <td></td>
                                <td></td>
                            ...
                            <tr>
                                ...
                                <td colspan=2><input type="text" id="alternate_sat" data-bind="value:form.model.alternate_sat"></td>
                                <td></td>
                                <td></td>
...
@include('app.employee-file.employee-master-data-confi.js')

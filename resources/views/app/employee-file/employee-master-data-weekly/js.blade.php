            ...
            var viewModel = kendo.observable({ 
                ...
                ds : {
                    maingrid : new kendo.data.DataSource({
                        transport : {
                            read : {
                                url : 'employee-master-data-weekly/list',
                ...
                buttonHandler : {  
                    ...
                    save : async function(e){
                        ...
                        $.post('employee-master-data-weekly/save',{
                            data : json_data
                        },function(data,staus){
                            swal_success(data);
                            ...
                            {
                                let url  = `employee-master-data-weekly${data}`;
                                setTimeout(function(){
                                    read(url,viewModel);
                                }, 500);
                            }   
                    ...
                    view : async function(e){
                        ...
                        let url  = `employee-master-data-weekly/read/${data.id}`;

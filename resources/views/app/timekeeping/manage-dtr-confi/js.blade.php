        ...
        $(document).ready(function(){
            ...
            var viewModel = kendo.observable({ 
                ...
                ds : {
                    maingrid : new kendo.data.DataSource({
                        transport : {
                            read : {
                                url : 'manage-dtr-confi/payroll-period',
                                type : 'get',
                                dataType : 'json',
                                complete : function(e){
                    ...
                    subgrid :  new kendo.data.DataSource({ //timekeeping/manage-dtr-confi/get-employee-list/1
                        transport : {
                            read : {
                                url : 'manage-dtr-confi/get-employee-list/0',
                                type : 'get',
                                dataType : 'json',
                                complete : function(e){
                    ...
                    dtrgrid :  new kendo.data.DataSource({
                        transport : {
                            read : {
                                url : 'manage-dtr-confi/get-employee-dtr-logs/0/0',
                                type : 'get',
                                dataType : 'json',
                                complete : function(e){
                            ...
                            update : {
                                url : 'manage-dtr-confi/update-dtr',
                                type : 'post',
                                dataType : 'json',
                                complete : function (e){
                    ...
                    sched : new kendo.data.DataSource({
                        transport : {
                            read : {
                                url : 'manage-dtr-confi/get-employee-schedules',
                                type : 'get',
                                dataType : 'json',
                                complete : function(e){
                    ...
                    departments : new kendo.data.DataSource({
                        transport : {
                            read : {
                                url : 'manage-dtr-confi/list-department',
                                type : 'get',
                                dataType : 'json',
                                complete : function(e){
                ...
                buttonHandler : {
                    prepare : function(e){
                        ...
                        $.post('manage-dtr-confi/prepare',{
                            period_id : data.id
                        },function(){
                            let empListUrl = `manage-dtr-confi/get-employee-list/${data.id}`;
                    ...
                    download : function(e){
                        ...
                        let url = `manage-dtr-confi/download/${data.id}`;
                        window.open(url);
                    ...
                    computeAll : function(e){
                        ...
                        let url = `manage-dtr-confi/computeAll`;

                        $.post('manage-dtr-confi/compute-all',{
                            period_id : data.id
                        },function(data){
                            Swal.fire({
                            //position: 'top-end',
                    ...
                    manage : function(e){
                        ...
                        if(viewModel.selectedPeriod!=null)
                        {
                            ...
                            let rawLogsUrl = `manage-dtr-confi/get-employee-raw-logs/${viewModel.selectedPeriod.id}/${data.biometric_id}`;
                            ...
                            let dtrUrl = `manage-dtr-confi/get-employee-dtr-logs/${viewModel.selectedPeriod.id}/${data.biometric_id}`;
                    ...
                    drawLogs : function()
                    {
                        ...
                        $.post('manage-dtr-confi/draw-logs',{
                    ...
                    compute : function()
                    {
                        ...
                        $.post('manage-dtr-confi/compute-logs',{
                            period_id : viewModel.selectedPeriod.id,
                            biometric_id : viewModel.selectedEmployee
                        },function(){
                            viewModel.ds.dtrgrid.read();
                    ...
                    print : function (){
                        let url = `manage-dtr-confi/print/${viewModel.selectedPeriod.id}`;
                        window.open(url);
                    },   
                    computeAll : function() {
                    ...
                    clear : function()
                    {
                        $.post('manage-dtr-confi/clear-logs',{
                            period_id : viewModel.selectedPeriod.id,
                            biometric_id : viewModel.selectedEmployee
                        },function(){
                            viewModel.ds.dtrgrid.read();
                    ...
                    iPrint : function()
                    {
                        let url = `manage-dtr-confi/iprint/${viewModel.selectedPeriod.id}/${viewModel.selectedEmployee}`;
                        window.open(url);
                    }
            ...
            $("#maingrid").kendoGrid({
                ...
                change : function(e){
                    ...
                    let empListUrl = `manage-dtr-confi/get-employee-list/${selectedItem.id}`;
                    viewModel.ds.subgrid.transport.options.read.url = empListUrl;
                    viewModel.ds.subgrid.read();

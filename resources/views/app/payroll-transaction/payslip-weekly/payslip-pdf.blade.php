                ...
                <div style="width:310px;padding : 4px 16px;border : 1px solid black;margin-right:4px;margin-bottom : 8px;display:inline-block;page-break-inside:avoid"> 
                    <table border=0 style="width:100%;" >
                        ...
                        <tr>
                            ...
                            <td style="width:20%;font-size : 9pt;">Cash Advance</td>
                        </tr>
                        <tr>
                           
                            <td style="width:20%;font-size : 10pt;text-align:right;border-bottom: 1px solid black;padding: 0px 6px;"> {{ number_format($e->otherEearnings['earnings'],2) }}</td>
                            <td style="width:20%;font-size : 10pt;text-align:right;border-bottom: 1px solid black;padding: 0px 6px;"> {{ number_format($e->otherEearnings['retro_pay'],2) }}</td>
                            
                            <td style="width:20%;font-size : 10pt;text-align:right;border-bottom: 1px solid black;padding: 0px 6px;"> {{ number_format($e->deductions['deductions'],2) }}</td>
                            <td style="width:20%;font-size : 10pt;text-align:right;border-bottom: 1px solid black;padding: 0px 6px;"> {{ number_format($e->deductions['canteen'],2) }}</td>
                            <td style="width:20%;font-size : 10pt;text-align:right;border-bottom: 1px solid black;padding: 0px 6px;"> {{ number_format($e->deductions['cash_advance'],2) }}</td>
                        </tr>
                        </tr>
                        <tr>
                            <td colspan=6>&nbsp;</td>

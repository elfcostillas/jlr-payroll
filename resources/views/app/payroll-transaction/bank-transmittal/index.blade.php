                    ...
                    <div class="card card-secondary">
                        ...
                        <div class="card-body"> 
                            <table class="formTable" border=0 style="width:100%">
                                ...
                                <tr>
                                    <td colspan=2 > <input type="text" id="posted_period"></td>
                                    <td></td>
                                    <td></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td> <button class="k-grid-add k-button k-button-md k-rounded-md k-button-solid k-button-solid-base fixwidth" data-bind="click : buttonHandler.download"> Download</button> </td>
                                    <td></td>
                                    <td></td>
                                    <td></td>
                                </tr>
...
@include('app.payroll-transaction.bank-transmittal.js')
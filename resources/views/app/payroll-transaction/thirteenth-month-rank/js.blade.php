        ...
        var viewModel = kendo.observable({ 
                ...
                handler : {
                    show : function(data){
                        ...
                        let url = `thirteenth-month-jlr/show-table/${selectedYear.value()}/${selectedMonth.value()}`;
                    ...
                    download : function()
                    {
                        ...
                        let url = `thirteenth-month-jlr/download-excel/${selectedYear.value()}/${selectedMonth.value()}`;
                        window.open(url);
                    },
                    ...
                    banktransmittal : function()
                    {
                        ...
                        let url = `thirteenth-month-jlr/download-banktransmittal/${selectedYear.value()}/${selectedMonth.value()}`;
                        window.open(url);
                    },
                    post : function()
                    {
                        ...
                        Swal.fire({
                                ...
                                if (result.value) {                       
                                    $.post('thirteenth-month-jlr/post',{
                    ...
                    print : function(){
                        ...
                        let url = `thirteenth-month-jlr/print-payslip/${selectedYear.value()}/${selectedMonth.value()}`;
                        window.open(url);
                    },
                    conso : function() {
                        let selectedYear = $("#pyear").data("kendoDropDownList");
                        ...
                        let url = `thirteenth-month-jlr/download-conso/${selectedYear.value()}/${selectedMonth.value()}`;
                        window.open(url);
                    },
                    downloadInActive : function() {
                        ...
                        let url = `thirteenth-month-jlr/download-excel-inactive/${selectedYear.value()}/${selectedMonth.value()}`;
                        window.open(url);
                    }
                }
            });

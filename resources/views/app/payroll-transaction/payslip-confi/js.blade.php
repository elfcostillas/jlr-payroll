        ...
        $(document).ready(function(){
            ...
            var viewModel = kendo.observable({ 
                ds : {
                    payperiod : new kendo.data.DataSource({
                        transport : {
                            read : {
                                url : 'payslip-confi/posted-period',
                                type : 'get',
                                dataType : 'json',
                                complete : function(e){
                    ...
                    employees : new kendo.data.DataSource({
                        transport : {
                            read : {
                                url : 'payslip-confi/get-employees/0/0/0',
                                type : 'get',
                                dataType : 'json',
                                complete : function(e){
                ...
                buttonHandler : {
                    ...
                    web : function(e){
                        ...
                        let url = `payslip-confi/web-view/${period}/${division}/${department}/${biometric_id}`;
                        window.open(url);
                    }
                }
            });
            ...
            $("#department_id").kendoDropDownList({
                ...
                change: function(e){
                    ...
                    let url = `payslip-confi/get-employees/${period}/${division}/${department}`;

...
@section('title')
    <h4> Payroll Register - Support Group <h4>
@endsection
@section('content')
    <div class="">
        <div id="viewModel" >
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="card card-secondary">
                        ...
                        <table class="formTable" border=0 style="width:100%">
                            <tr>
                                <td colspan=5>Posted Payroll Period</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td style="text-align:center;" > <button class="k-grid-add k-button k-button-md k-rounded-md k-button-solid k-button-solid-base fixwidth" data-bind="click : buttonHandler.posted_pdf"> PDF</button> </td>
...
@include('app.payroll-transaction.payroll-register-weekly.js')
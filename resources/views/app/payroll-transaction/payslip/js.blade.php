        ...
        $(document).ready(function(){
            ...
            var viewModel = kendo.observable({ 
                ds : {
                    ...
                    employees : new kendo.data.DataSource({
                        transport : {
                            read : {
                                url : 'payslip/get-employees/0/0/0',
                                type : 'get',
                                dataType : 'json',
                                complete : function(e){
                ...
                buttonHandler : {
                    ...
                    web : function(e){
                        ...
                        let url = `payslip/web-view/${period}/${division}/${department}/${biometric_id}`;
                        window.open(url);
                    }
                }
            });
            ...
            $("#department_id").kendoDropDownList({
                ...
                change: function(e){
                    ...
                    let url = `payslip/get-employees/${period}/${division}/${department}`;

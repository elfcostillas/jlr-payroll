...
class DTRExport implements ShouldAutoSize,WithColumnFormatting,FromView,WithEvents 
{
    ...
    public function view(): View
    {
        ...
        return view('app.timekeeping.manage-dtr.dtr-download',['data' => $this->data ]);
    }

...
class PLStatementYearExcel implements ShouldAutoSize,WithColumnFormatting,FromView,WithEvents,WithColumnWidths 
{
    protected $data;
    protected $label;
    ...
    public function view(): View
    {
        ...
        // 	'data' => $this->data
        // ]);
        return view('accounting.plstatement.profit-loss-division-year-ex',[
            'acct'=>$this->data['acct'],

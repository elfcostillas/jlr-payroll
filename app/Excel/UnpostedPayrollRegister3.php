...
class UnpostedPayrollRegister3 implements ShouldAutoSize,WithColumnFormatting,FromView,WithEvents,WithDrawings
{
    ...
    {
		//dd($this->label['asOf']);
        return view('app.payroll-transaction.payroll-register.payroll-register-ex3', [

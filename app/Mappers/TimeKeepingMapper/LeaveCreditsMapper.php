...
class LeaveCreditsMapper extends AbstractMapper {
    ...
    {
        $result = $this->model->select(DB::raw("employee_names_vw.*,line_id,fy_year,IFNULL(vacation_leave,0) vacation_leave,IFNULL(sick_leave,0) sick_leave,IFNULL(summer_vacation_leave,0) summer_vacation_leave,IFNULL(paternity_leave,0) paternity_leave,IFNULL(bereavement,0) bereavement"))

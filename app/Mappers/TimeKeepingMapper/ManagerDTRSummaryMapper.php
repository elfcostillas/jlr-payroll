...
class ManagerDTRSummaryMapper extends AbstractMapper
{
    ...
    {
        $result = $this->model->select(DB::raw("edtr_totals.*,employee_names_vw.employee_name, (ndays+vl_wp+vl_wop+sl_wp+sl_wop+bl+awol+brv+reghol_pay+sphol_pay+dblhol_pay+dblsphol_pay) as total_ndays"))

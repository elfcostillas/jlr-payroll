...
*/
        $data = $this->model->select('period_id','earnings','deductions','retro_pay','biometric_id','canteen','remarks','canteen_bpn','canteen_bps','canteen_agg','remarks2','cash_advance','office_account')
